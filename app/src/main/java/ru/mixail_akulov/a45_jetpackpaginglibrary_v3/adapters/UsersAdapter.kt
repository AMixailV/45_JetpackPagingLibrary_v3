...
import ru.mixail_akulov.a45_jetpackpaginglibrary_v3.R
import ru.mixail_akulov.a45_jetpackpaginglibrary_v3.databinding.ItemUserBinding
import ru.mixail_akulov.a45_jetpackpaginglibrary_v3.views.UserListItem
...
class UsersAdapter(
    ...
    interface Listener {
        /**
         * Вызывается, когда пользователь нажимает кнопку «Удалить» в элементе списка.
         */
        fun onUserDelete(userListItem: UserListItem)

        /**
         * Вызывается, когда пользователь нажимает кнопку «Звездочка» в элементе списка.
         */
